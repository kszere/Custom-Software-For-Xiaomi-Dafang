...
/system/sdcard/bin/busybox nohup /system/sdcard/bin/v4l2rtspserver -fMJPG -W 1920 -H 1080 -F 10 &>/dev/null &
...
/system/sdcard/bin/ossplay -g 100 /system/sdcard/sounds/startup.wav &
